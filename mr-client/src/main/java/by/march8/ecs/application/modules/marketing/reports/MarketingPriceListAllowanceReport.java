...
/**
 * @author Andy 24.04.2017.
 */
public class MarketingPriceListAllowanceReport extends AbstractMarketingReport {
    protected String month;

    public MarketingPriceListAllowanceReport(final MarketingReportData report) {
        super(report);
        create();
    }
    ...
    ReportProperties prepareProperties(final ReportProperties properties) {
        ...
        properties.setBlankName("marketing_al_" + priceList.getDocumentNumber().replace("/", "-"));
        properties.getTemplate().setTemplateName("marketingPriceListAdditionAllowance.ots");
        return properties;
    }
            ...
            for (Object o : detailList) {
                ...
                if (item != null) {
                    ...
                    XCellRange xCellRange = xSpreadsheet
                            .getCellRangeByPosition(5, row, 5,
                                    row);
                ...
                rowFormatCenterLeft(xSpreadsheet, row, 6, 10.0f);
                row++;
            }
