...
/**
 * @author Andy 10.04.2018 - 9:24.
 */
public abstract class AbstractDisplacementReport implements IReport {


    protected MainController controller;
    protected ProgressBar pb;
    protected DisplacementReportData reportData;
    protected DisplacementInvoiceView priceList;
    ...
    public AbstractDisplacementReport(DisplacementReportData report) {
        reportData = report;
        if (report != null) {
    ...
    private void init() {
        ...
        reportProperties.setBlankName("marketing_pl_");
