 ...
 */
public abstract class AbstractMarketingReport extends AbstractReport implements IReport {

    protected MainController controller;
    protected MarketingReportData reportData;
    protected MarketingPriceListItem priceList;
    ...
    public AbstractMarketingReport(MarketingReportData report) {
        reportData = report;
        if (report != null) {
