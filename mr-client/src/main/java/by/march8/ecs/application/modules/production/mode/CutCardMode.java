 ...
 */
public class CutCardMode extends AbstractFunctionalMode {
    ...
    private List<CutCardDocumentView> data;
    private GridViewPort<CutCardDocumentView> gvDocuments;
    ...
    public CutCardMode(MainController mainController) {
        controller = mainController;
        modeName = "Журнал карт кроя";
        ...
        gvDocuments = new GridViewPort<>(CutCardDocumentView.class, false);
    ...
    public void viewDetail() {
        CutCardDocumentView selectedItem = gvDocuments.getSelectedItem();
        if (selectedItem != null) {
    ...
    public void updateContent() {
        DaoFactory<CutCardDocumentView> factory = DaoFactory.getInstance();
        IGenericDao<CutCardDocumentView> dao = factory.getGenericDao();
        ...
        try {
            data.clear();
            data.addAll(dao.getEntityListByNamedQuery(CutCardDocumentView.class, "CutCardDocumentView.findByPeriod", criteria));
