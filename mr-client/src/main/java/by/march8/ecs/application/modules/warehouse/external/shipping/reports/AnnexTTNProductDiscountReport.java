 ...
 */
public class AnnexTTNProductDiscountReport extends AbstractInvoiceReport {

    public AnnexTTNProductDiscountReport(final SaleDocumentReport report) {
        super(report);
...
/*                    xCell = xSpreadsheet.getCellByPosition(16, row);
                ...
                xCell = xSpreadsheet.getCellByPosition(16, row);
                xCell.setFormula(item.getEanCode().trim() + "\nЦена произ.:" + String.valueOf(item.getValuePrice()) + "\nОпт.надбавка:0%" + "\nскидка с отп.цены:" + saleDocumentBase.getDiscountValue() + "%");
