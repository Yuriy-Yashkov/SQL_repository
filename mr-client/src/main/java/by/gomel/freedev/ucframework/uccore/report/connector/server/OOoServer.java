package by.gomel.freedev.ucframework.uccore.report.connector.server;
...
public class OOoServer {
    ...
    public static List getNewDefaultOOoOptions() {
     ...
     */
    public void start(String oooAcceptOption, boolean bootstrap) throws BootstrapException, IOException, MalformedURLException {

        // find office executable relative to this class's class loader
        String sOffice = System.getProperty("os.name").startsWith("Windows") ? "soffice.exe" : "soffice";

        if (bootstrap) {
            this.oooOptions = getNewDefaultOOoOptions();
        }
