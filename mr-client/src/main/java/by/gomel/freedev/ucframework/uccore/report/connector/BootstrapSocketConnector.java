package by.gomel.freedev.ucframework.uccore.report.connector;

import by.gomel.freedev.ucframework.uccore.report.connector.server.OOoServer;
...
public class BootstrapSocketConnector extends BootstrapConnector {
     ...
     */
    public static final XComponentContext bootstrap(String oooExecFolder, boolean newBootStrap) throws BootstrapException {
