...
public class KTForm extends javax.swing.JDialog {
    Vector col = new Vector();
    Vector klientList = new Vector();
    Vector allKTList = new Vector();
    String search = new String();
    String typeAnalizRB;
    DefaultTableModel tm = null;
    AnalizRR analizRB = null;
    ReportPDB pdb;
    boolean flagOtchet = false;
    ...
    public KTForm(java.awt.Dialog parent, boolean modal, String type) {
        super(parent, modal);
        initComponents();
        init();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Выбор региона");

        jLabel2.setText("Ключевое слово или код:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTable1.getSelectedRow() != -1) {
            analizRB.setNameKT(Integer.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString().trim()),
    ...
    private void createClientForm() {
        try {
            pdb = new ReportPDB();
            allKTList = pdb.initTableKT();
        } catch (Exception e) {
            allKTList = new Vector();
            JOptionPane.showMessageDialog(null, "Ошибка! " + e.getMessage(), "Ошибка", javax.swing.JOptionPane.ERROR_MESSAGE);
        } finally {
            pdb.disConn();
        }

        tm = new DefaultTableModel(allKTList, col);
    ...
    private void init() {
        ImageIcon iconfavorites = UtilFunctions.createIcon("/Img/config-kt.png");
