...
public class ClientForm extends javax.swing.JDialog {
    ...
    public ClientForm(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Выбор заказчика");

        marketingform = (MarketingForm) parent;
        marketingform.setIdKlient(-10);
        marketingform.setNameKlient("не выбран");
        MarketingForm.date = MarketingForm.tekDate;
        MarketingForm.noteorder = "";

        pdb = marketingform.pdb;
        pdb.updateCart();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTable1.getSelectedRow() != -1) {
            marketingform.setIdKlient(Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString()));
            marketingform.setNameKlient((jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString().trim()));
    ...
    private void createClientForm() {
        ImageIcon iconfavorites = MarketingForm.createIcon("/Img/config-users.png");
