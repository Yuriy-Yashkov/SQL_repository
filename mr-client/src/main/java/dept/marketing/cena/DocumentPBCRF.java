 ...
 * @author lidashka
 */
public class DocumentPBCRF extends JDialog {
    JPanel osnova;
    JPanel upPanel;
    JPanel downPanel;
    JPanel panel;
    ...
    public DocumentPBCRF(CenaForm parent, boolean modal, Vector dataTable) {
        super(parent, modal);
        init();
    ...
    private void init() {
        ...
        title2 = new JLabel("с учётом повышающих коэффициентов");
                ...
                try {
                    if (UtilFunctions.checkDate(new SimpleDateFormat("dd.MM.yyyy").format(date.getDate()))) {
                        ...
                        try {
                            ...
                            oo.createReport("PriceTableDocumentPBCRF.ots");
                        } catch (Exception e) {
                    ...
                    JOptionPane.showMessageDialog(null, "Введено некорректное значение: " + e.getMessage(), "Завершено!", javax.swing.JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        ...
        but1p.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                new ClientForm(DocumentPBCRF.this, true, UtilCena.DOCUMENT_LIST1);
            }
        });
        ...
        but2p.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                new ClientForm(DocumentPBCRF.this, true, UtilCena.DOCUMENT_LIST2);
            }
        });
        ...
        but3p.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                new ClientForm(DocumentPBCRF.this, true, UtilCena.DOCUMENT_LIST3);
            }
        });
        ...
        but4p.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                new ClientForm(DocumentPBCRF.this, true, UtilCena.DOCUMENT_LIST4);
            }
        });
        ...
        but5p.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                new ClientForm(DocumentPBCRF.this, true, UtilCena.DOCUMENT_LIST5);
            }
        });
