...
public class ClientForm extends javax.swing.JDialog {
    ...
    DocumentPBCRF documentPBCRF = null;
    DB db;
    boolean flagDocumentPBCRF = false;
    ...
    public ClientForm(javax.swing.JDialog parent, boolean modal, String type) {
        super(parent, modal);
        initComponents();
        setTitle("Выбор покупателя");

        documentPBCRF = (DocumentPBCRF) parent;
        typeDocumentPBCRF = type;
        flagDocumentPBCRF = true;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTable1.getSelectedRow() != -1) {
            if (flagDocumentPBCRF) {
                documentPBCRF.setNameClient((jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString().trim()), typeDocumentPBCRF);
            }
            dispose();
        } else
