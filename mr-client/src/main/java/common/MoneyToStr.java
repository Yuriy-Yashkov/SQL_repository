...
public class MoneyToStr {
    ...
    /**
     * Трёх буквенное обозначение валюта (RUB)
     */
     ...
     * Конструктор из Long
     */
    public MoneyToStr(long l, String typeMoney) {
     ...
     */
    public MoneyToStr(double l, String typeMoney) {
        String s = String.valueOf(l);
        if (!s.contains("."))
            s += ".0";
        this.amount = new BigDecimal(s);
     ...
     */
    public MoneyToStr(String s, String typeMoney) {
        s = s.replace(',', '.');
        if (!s.contains("."))
            s += ".0";
        this.amount = new BigDecimal(s);
    ...
    public String num2str(boolean stripkop) {
        ...
        if ("RUB".equals(typeMoney) || "BYR".equals(typeMoney)) {
            forms = new String[][]{
                    {"копейка", "копейки", "копеек", "1"},
                    {"рубль", "рубля", "рублей", "0"},
                    {"тысяча", "тысячи", "тысяч", "1"},
        ...
        } else if ("kg".equals(typeMoney)) {
            forms = new String[][]{
                    {"грамм", "грамма", "граммов", "1"},
        ...
        } else if ("шт".equals(typeMoney)) {
            forms = new String[][]{
                    {"", "", "", "0"},
                    {"единица", "единицы", "единиц", "0"},
                    {"тысяча", "тысячи", "тысяч", "1"},
                    {"миллион", "миллиона", "миллионов", "0"},
                    {"миллиард", "миллиарда", "миллиардов", "0"},
                    {"триллион", "триллиона", "триллионов", "0"},
