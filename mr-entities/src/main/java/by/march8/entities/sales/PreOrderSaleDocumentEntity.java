...
public class PreOrderSaleDocumentEntity extends BaseEntity {
    @Id
    ...
    public PreOrderSaleDocumentEntity() {

    }

    public PreOrderSaleDocumentEntity(PreOrderSaleDocumentEntity other) {
        this.id = other.id;
