...
WHERE ot1.[date] BETWEEN CONVERT(DATETIME, '2020-01-01', 102) and CONVERT(DATETIME, '2020-01-31', 102) 
and ot1.status = 0 

and (ot1.operac='Отгрузка покупателю' OR operac='Отгрузка материала'OR operac='Перемещение в розницу') AND export=1
